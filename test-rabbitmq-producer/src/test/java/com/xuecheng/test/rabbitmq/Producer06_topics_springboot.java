...
public class Producer06_topics_springboot {
    ...
    public void testSendEmail(){
         ...
         * 3、消息内容
         */
        rabbitTemplate.convertAndSend(RabbitmqConfig.EXCHANGE_TOPICS_INFORM_SPRING,"inform.email",message);
    ...
    public void testSendSMS(){
         ...
         * 3、消息内容
         */
        rabbitTemplate.convertAndSend(RabbitmqConfig.EXCHANGE_TOPICS_INFORM_SPRING,"inform.sms",message);
        System.out.println("Send Message is:'" + message + "'");
    }
