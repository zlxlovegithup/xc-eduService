...
public enum CourseCode implements ResultCode {
    ...
    CORSE_GET_NOTEXISTS(false,31103,"你查询的课程不存在!"),
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false,31104,"创建课程索引信息失败"),
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31105,"媒体资源信息为空!"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31106,"该节点不是叶子节点,请选择叶子节点！");
