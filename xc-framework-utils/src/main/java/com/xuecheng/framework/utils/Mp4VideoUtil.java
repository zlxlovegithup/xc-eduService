...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String mp4folder_path = "F:\\Ffmpeg_Video\\video\\";
    ...
    public String generateMp4(){
        ...
        /*
        ffmpeg.exe -i  test1.avi -c:v libx264 -s 1280x720 -pix_fmt yuv420p -b:a 63k -b:v 753k -r 18 .\test1.mp4
         */
        List<String> commend = new ArrayList<String>();
        //commend.add("D:\\ffmpeg-20200412-f1894c2-win64-static\\bin\\ffmpeg.exe");
        commend.add(ffmpeg_path);
        commend.add("-i");
//        commend.add("F:\\Ffmpeg_Video\\test1\\test1.avi");
    ...
    public static void main(String[] args) throws IOException {
        ...
        String mp4_path = "F:\\Ffmpeg_Video\\video\\8\\0\\809694a6a974c35e3a36f36850837d7c\\";
